...
#define SCREEN_TEXT_COLUMNS 64
#define SCREEN_TEXT_ROWS 32
...
void draw_Box(unsigned short x, unsigned short y, 	unsigned short length, unsigned short height, unsigned short borderpx, unsigned short borderfill, unsigned short centrefill);
