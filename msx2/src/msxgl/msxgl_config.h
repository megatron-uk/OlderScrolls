...
//─────────────────────────────────────────────────────────────────────────────
#pragma once
#ifndef MSXGL_CONFIG_H
#define MSXGL_CONFIG_H
...
#define VDP_AUTO_INIT				FALSE	// Call VDP_Initialize() at the first call to VDP_SetMode()
...
#define VDP_INIT_50HZ				VDP_INIT_AUTO
...
#define MEM_USE_FASTCOPY			TRUE	// Add support for fast-copy function (using unrolled-LDI loop)
...
// MSX-Music options
#define MSXAUDIO_USE_RESUME			FALSE	// Add function to allow playback pause and resume

// MSX-Audio options
#define MSXMUSIC_USE_RESUME			FALSE	// Add function to allow playback pause and resume

// SCC options
#define SCC_USE_EXTA				FALSE	// Add helper functions to handle PSG settings
#define SCC_USE_RESUME				FALSE	// Add function to allow playback pause and resume
...
// PT3 options
#define PT3_SKIP_HEADER				FALSE	// Don't use PT3 data header (first 100 bytes must be truncated)
#define PT3_AUTOPLAY				FALSE	// Play music automatically
#define PT3_EXTRA					FALSE	// Add helper functions

// TriloTracker options
#define TRILO_USE_SFXPLAY			FALSE	// Add SFX playback through Trilo SCC player (ayFX + SCC format)
#define TRILO_USE_TREMOLO			FALSE	// Add support for tremolo effect (little bit expensive)
